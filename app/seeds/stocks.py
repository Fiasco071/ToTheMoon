...
def seed_stocks():
    stock1 = Stock(ticker='RQM666', long_name='Rami Martinez SWAG', i_price=49.69)
    stock2 = Stock(ticker='KJHK', long_name='BUSSIN BUSSIN CORP', i_price=39.27)
    stock3 = Stock(ticker='MUKH', long_name='POOGLE', i_price=4.19)
    ...
    stock8 = Stock(ticker='DFCJ', long_name='POKEMON', i_price=12.99)
    stock9 = Stock(ticker='BVCF', long_name='TACO BELL', i_price=224.56)
